...
/**
 * A class representing an implementation of the Image Processor Controller With Mosaic.
 * This is an exact copy of the existing controller, with the only difference being that mosaic
 * commands are supported.
 * This is to evade direct code modification.
 */
public class ImageProcessorControllerImplWithMosaic implements ImageProcessorController {
   ...
   */
  public ImageProcessorControllerImplWithMosaic(Readable input, ImageProcessView view, ImageDict dict) {
    if (input == null) {
      throw new IllegalArgumentException("ImageProcessorControllerImplWithMosaic constructor fields cannot" +
              "be null!");
    }
    this.input = input;
    this.view = view;
